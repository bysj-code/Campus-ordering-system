  ...
  >
    ...
    >
      ...
      >
        ...
        v-show="user_group == '管理员' || $check_action('/registered_users/table')"
    ...
    >
      ...
      index="mall"
      v-show="
        user_group == '管理员' || $check_group(['/goods/table', '/order/table'])
      "
    >
      <template slot="title"
        ><i class="el-icon-s-goods"></i><span>购物管理</span></template
      >
                 <el-menu-item
        v-show="user_group == '管理员' || $check_action('/food_information/table')"
        index="/food_information/table"
        class="bg-hover"
        ><span>餐品信息</span></el-menu-item
      >
