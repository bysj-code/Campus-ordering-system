		...
		<el-form ref="form" :model="form" status-icon label-width="120px" v-if="is_view()">
			...
			<el-col :xs="24" :sm="12" :lg="8" class="el_form_item_warp">
				...
				<el-form-item label="商家编号" prop="seller_no">
												<el-input id="seller_no" v-model="form_sub['seller_no']" placeholder="请输入商家编号"
							  v-if="user_group === '管理员' || (form_sub['seller_id'] && $check_field('set','seller_no')) || (!form_sub['seller_id'] && $check_field('add','seller_no'))"></el-input>
					<div v-else-if="$check_field('get','seller_no')">{{form_sub['seller_no']}}</div>
											</el-form-item>
			</el-col>
				...
				<el-form-item label="负责人" prop="person_in_charge">
							  ...
							  v-if="user_group === '管理员' || (form_sub['seller_id'] && $check_field('set','person_in_charge')) || (!form_sub['seller_id'] && $check_field('add','person_in_charge'))"></el-input>
					<div v-else-if="$check_field('get','person_in_charge')">{{form_sub['person_in_charge']}}</div>
											</el-form-item>
			</el-col>
