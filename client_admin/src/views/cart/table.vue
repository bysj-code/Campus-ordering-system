			...
			<el-row>
				...
				<el-col :xs="24" :sm="24" :lg="24" class="search_btn_wrap">
					...
					<el-col :xs="24" :sm="12" :lg="12" class="search_btn_2">
						<el-form-item>
							<el-button v-if="user_group == '管理员' || $check_action('/cart/table','del')" class="search_btn_del" type="danger" @click="delInfo()">删除</el-button>loat-right" type="danger" @click="delInfo()">删除</el-button>
							<router-link v-if="user_group == '管理员' || $check_action('/cart/view')"
								to="./view?"><el-button class="el-button el-button--default el-button--primary search_btn_add">添加</el-button>
							</router-link>
						</el-form-item>
					</el-col>
				</el-col>
