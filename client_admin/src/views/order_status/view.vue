	...
	<el-main class="bg edit_wrap">
		<el-form ref="form" :model="form" status-icon label-width="120px" v-if="is_view()">
				...
				<el-form-item label="餐品名称" prop="product_name">
							  ...
							  v-if="user_group === '管理员' || (form['order_status_id'] && $check_field('set','product_name')) || (!form['order_status_id'] && $check_field('add','product_name'))" :disabled="disabledObj['product_name_isDisabled']"></el-input>
				...
				<el-form-item label="商家编号" prop="seller_no">
							...
							<!--v-if="user_group === '管理员' || (form['order_status_id'] && $check_field('set','seller_no')) || (!form['order_status_id'] && $check_field('add','seller_no'))" :disabled="disabledObj['seller_no_isDisabled']"></el-input>-->
							<!--<div v-else-if="$check_field('get','seller_no')">{{form['seller_no']}}</div>-->
							<el-select v-if="user_group === '管理员' || (form['order_status_id'] && $check_field('set','seller_no')) || (!form['order_status_id'] && $check_field('add','seller_no'))" id="seller_no" v-model="form['seller_no']" :disabled="disabledObj['seller_no_isDisabled']">
				...
				<el-form-item label="联系电话" prop="contact_number">
							  ...
							  v-if="user_group === '管理员' || (form['order_status_id'] && $check_field('set','contact_number')) || (!form['order_status_id'] && $check_field('add','contact_number'))" :disabled="disabledObj['contact_number_isDisabled']"></el-input>
