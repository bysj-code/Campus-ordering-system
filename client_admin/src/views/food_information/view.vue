		...
		<el-form ref="form" :model="form" status-icon label-width="120px" v-if="is_view()">
            ...
            <el-col :xs="24" :sm="12" :lg="8" class="el_form_item_warp">
				...
				<el-form-item label="原材料" prop="raw_material">
							  ...
							  v-if="user_group === '管理员' || (form['food_information_id'] && $check_field('set','raw_material')) || (!form['food_information_id'] && $check_field('add','raw_material'))" :disabled="disabledObj['raw_material_isDisabled']"></el-input>
				...
				<el-form-item label="商家编号" prop="seller_no">
							...
							<!--v-if="user_group === '管理员' || (form['food_information_id'] && $check_field('set','seller_no')) || (!form['food_information_id'] && $check_field('add','seller_no'))" :disabled="disabledObj['seller_no_isDisabled']"></el-input>-->
							<!--<div v-else-if="$check_field('get','seller_no')">{{form['seller_no']}}</div>-->
							<el-select v-if="user_group === '管理员' || (form['food_information_id'] && $check_field('set','seller_no')) || (!form['food_information_id'] && $check_field('add','seller_no'))" id="seller_no" v-model="form['seller_no']" :disabled="disabledObj['seller_no_isDisabled']">
            ...
            submit_goods(source_id,add_flag){
				let customize_field = []
							customize_field.push({"field_name":"口味","field_value":this.form.flavor});
									customize_field.push({"field_name":"原材料","field_value":this.form.raw_material});
									customize_field.push({"field_name":"商家编号","field_value":this.form.seller_no});
									customize_field.push({"field_name":"店铺名称","field_value":this.form.store_name});
			                this.goods_form = {
                    goods_id: 0,
