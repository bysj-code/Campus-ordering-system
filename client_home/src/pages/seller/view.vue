          ...
          <view class="">
            <uni-forms :modelValue="form"  v-if="is_view()">
              ...
              <uni-forms-item v-if="$check_field('get','seller_no') || ($check_field('add','seller_no') || $check_field('set','seller_no'))" label="商家编号" name="seller_no">
                            <uni-easyinput type="text" v-model="form['seller_no']" v-if="user_group === '管理员' || (form['seller_id'] && $check_field('set','seller_no')) || (!form['seller_id'] && $check_field('add','seller_no'))" :disabled="disabledObj['seller_no_isDisabled']" />
                <!-- 仅查看 -->
                <text v-else-if="$check_field('get','seller_no')">
                  {{ form['seller_no'] }}
                </text>
                          </uni-forms-item>
              ...
              <uni-forms-item v-if="$check_field('get','person_in_charge') || ($check_field('add','person_in_charge') || $check_field('set','person_in_charge'))" label="负责人" name="person_in_charge">
                            <uni-easyinput type="text" v-model="form['person_in_charge']" v-if="user_group === '管理员' || (form['seller_id'] && $check_field('set','person_in_charge')) || (!form['seller_id'] && $check_field('add','person_in_charge'))" :disabled="disabledObj['person_in_charge_isDisabled']" />
                <!-- 仅查看 -->
