<template>
  <view class="page_seller diy_table diy_table_tml" id="seller_table">
    <!-- 筛选模块(开始) -->
    <view>
          ...
          <view>
            <view class="">
              ...
              <uni-forms :modelValue="query">
                    <uni-forms-item label="店铺名称" name="store_name">
                      <uni-easyinput type="text" v-model="query.store_name" placeholder="店铺名称" />
                    </uni-forms-item>
                  </uni-forms>
              <!-- /搜索栏 -->
        ...
        <view>
          <view>
            <view class="table_padding_top">
              <navigator class="nav_left" url="/pages/seller/view?" v-show="user_group == '管理员' || $check_action('/seller/table','add') || $check_action('/seller/view','add')">添加</navigator>
                            ...
                            <span>店铺名称</span>
								...
								<text>
									{{ o["store_name"] }}
													...
													<view v-if="0 && $check_field('get','person_in_charge')" class="col">
						<view class="view">
                          <view class="diy_title" v-if="true">
                            <span>负责人</span>
                          </view>
                  ...
                  <view class="col">
                    <view class="view">
                      <view class="create_time_block diy_filed diy_time">
                        ...
                        <button class="delete_a_btn" @click="delInfo(i)" v-show="user_group == '管理员' || $check_action('/seller/table','del') || $check_action('/seller/view','del')">删除</button>
                      </view>
                    </view>
                  </view>
					<view class="uni-padding-wrap uni-common-mt">
					<navigator  :url="'/pages/seller/view?' + field + '=' + o[field]"
                               v-show="user_group == '管理员' || $check_action('/seller/table','set') || $check_action('/seller/view','set') || $check_action('/seller/view','get')" class="btn btn-primary">详情</navigator>
	        					</view>
				</view>
			</view>
		</view>
