						...
						<view class="">
							<view  class="list_module">
									...
									<navigator class="my_module" url="/pages/registered_users/table" hover-class="hover">
										...
										<view v-if="user_group != '管理员' && $check_action('/seller/table','get')">
									<navigator class="my_module" url="/pages/seller/table" hover-class="hover">
										<div>
											...
											<view v-if="user_group != '管理员' && $check_action('/my_friend/table','get')">
									<navigator class="my_module" url="/pages/my_friend/table" hover-class="hover">
										<div>
											<text>我的好友</text>
											<span>></span>
										</div>
									...
									<navigator class="my_module" url="/pages/order_status/table" hover-class="hover">
										...
										<view v-if="user_group != '管理员' && $check_action('/business_analysis/table','get')">
									<navigator class="my_module" url="/pages/business_analysis/table" hover-class="hover">
										<div>
											<text>营业分析</text>
											<span>></span>
										</div>
										...
										<view v-if="user_group != '管理员' && $check_action('/food_recommendation/table','get')">
									<navigator class="my_module" url="/pages/food_recommendation/table" hover-class="hover">
										<div>
											<text>餐品推荐</text>
											<span>></span>
										</div>
										...
										<view v-if="user_group != '管理员' && $check_action('/comment_information/table','get')">
									<navigator class="my_module" url="/pages/comment_information/table" hover-class="hover">
										<div>
											<text>评论信息</text>
											<span>></span>
										</div>
