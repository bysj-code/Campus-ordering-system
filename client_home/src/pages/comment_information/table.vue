<template>
  <view class="page_comment_information diy_table diy_table_tml" id="comment_information_table">
    <!-- 筛选模块(开始) -->
    <view>
            ...
            <view class="">
              ...
              <uni-forms :modelValue="query">
                  <uni-forms-item label="订单编号" name="order_number">
                    ...
                    <uni-forms-item label="餐品名称" name="product_name">
                      <uni-easyinput type="text" v-model="query.product_name" placeholder="餐品名称" />
                    </uni-forms-item>
                            </uni-forms>
              <!-- /搜索栏 -->
        ...
        <view>
          <view>
            <view class="table_padding_top">
              <navigator class="nav_left" url="/pages/comment_information/view?" v-show="user_group == '管理员' || $check_action('/comment_information/table','add') || $check_action('/comment_information/view','add')">添加</navigator>
						...
						<view class="view">
							<view class="diy_title" v-if="true">
								...
								<span>
									...
									<view class="col" v-if="0 && $check_field('get','seller_no')">
						<view class="view">
							<view class="diy_title" v-if="true">
								<span>商家编号</span>
							</view>
								...
								<span>
									{{ get_user_seller_no(o['seller_no']) }}
								</span>
								</view>
													</view>
					</view>
						...
						<view class="view">
							<view class="diy_title" v-if="true">
								...
								<span>
									...
									<view class="col" v-if="1 && $check_field('get','comment_time')">
						<view class="view">
							<view class="diy_title" v-if="true">
								<span>评论时间</span>
							</view>
								...
								<span>
									{{ $toTime(o["comment_time"] ,"yyyy-MM-dd") }}
								</span>
								</view>
													</view>
					</view>
									<view class="col" v-if="0 && $check_field('get','rating_value')">
						<view class="view">
							<view class="diy_title" v-if="true">
								<span>评分值</span>
							</view>
								...
								<span>
									...
									<view class="col" v-if="0 && $check_field('get','comment_details')">
						<view class="view">
							<view class="diy_title" v-if="true">
								<span>评论详情</span>
							</view>
				...
				<view class="col">
					<view class="view">
						<view class="create_time_block diy_filed diy_time">
                          ...
                          <button class="delete_a_btn" @click="delInfo(i)" v-show="user_group == '管理员' || $check_action('/comment_information/table','del') || $check_action('/comment_information/view','del')">删除</button>
                        </view>
					</view>
				</view>
				<view class="uni-padding-wrap uni-common-mt">
					<navigator  :url="'/pages/comment_information/view?' + field + '=' + o[field]"
						v-show="user_group == '管理员' || $check_action('/comment_information/table','set') || $check_action('/comment_information/view','set') || $check_action('/comment_information/view','get')" class="btn btn-primary">详情</navigator>
					                    									</view>
			</view>
		</view>
	</view>
