						...
						<view class="view">
							<view class="diy_title" v-if="true">
								...
								<span>
									...
									<view class="col" v-if="1 && $check_field('get','record_time')">
						<view class="view">
							<view class="diy_title" v-if="true">
								<span>记录时间</span>
							</view>
				...
				<view class="uni-padding-wrap uni-common-mt">
					<navigator  :url="'/pages/order_status/view?' + field + '=' + o[field]"
						v-show="user_group == '管理员' || $check_action('/order_status/table','set') || $check_action('/order_status/view','set') || $check_action('/order_status/view','get')" class="btn btn-primary">详情</navigator>
					                    																		<!--跨表按钮-->
															<a type="button" size="mini" class="btn btn-primary" v-if="$check_action('/comment_information/view','add')" @click="to_form('/pages/comment_information/view',o)">
									<span>评论</span>
								</a>
																						</view>
			</view>
