<template>
  <view class="page_business_analysis diy_table diy_table_tml" id="business_analysis_table">
    <!-- 筛选模块(开始) -->
    <view>
        ...
        <view>
          <view>
            <view class="table_padding_top">
              <navigator class="nav_left" url="/pages/business_analysis/view?" v-show="user_group == '管理员' || $check_action('/business_analysis/table','add') || $check_action('/business_analysis/view','add')">添加</navigator>
                            ...
                            <span>标题</span>
								...
								<text>
									{{ o["title"] }}
													...
													<view v-if="0 && $check_field('get','seller_no')" class="col">
						<view class="view">
                          <view class="diy_title" v-if="true">
                            <span>商家编号</span>
                          </view>
								...
								<text>
									{{ get_user_seller_no(o['seller_no']) }}
													...
													<view v-if="0 && $check_field('get','store_name')" class="col">
						<view class="view">
                          <view class="diy_title" v-if="true">
                            <span>店铺名称</span>
                          </view>
                            ...
                            <span>统计时间</span>
								...
								<text>
									{{ o["statistical_time"] }}
													...
													<view v-if="0 && $check_field('get','total_revenue')" class="col">
						<view class="view">
                          <view class="diy_title" v-if="true">
                            <span>收入总额</span>
                          </view>
                  ...
                  <view class="col">
                    <view class="view">
                      <view class="create_time_block diy_filed diy_time">
                        ...
                        <button class="delete_a_btn" @click="delInfo(i)" v-show="user_group == '管理员' || $check_action('/business_analysis/table','del') || $check_action('/business_analysis/view','del')">删除</button>
                      </view>
                    </view>
                  </view>
					<view class="uni-padding-wrap uni-common-mt">
					<navigator  :url="'/pages/business_analysis/view?' + field + '=' + o[field]"
                               v-show="user_group == '管理员' || $check_action('/business_analysis/table','set') || $check_action('/business_analysis/view','set') || $check_action('/business_analysis/view','get')" class="btn btn-primary">详情</navigator>
	        					</view>
				</view>
			</view>
		</view>
