<template>
  <view class="page_food_recommendation diy_table diy_table_tml" id="food_recommendation_table">
    <!-- 筛选模块(开始) -->
    <view>
            ...
            <view class="">
              ...
              <uni-forms :modelValue="query">
                  <uni-forms-item label="餐品名称" name="product_name">
                      ...
                      <uni-easyinput type="text" v-model="query.flavor" placeholder="口味" />
                    </uni-forms-item>
                        </uni-forms>
              <!-- /搜索栏 -->
        ...
        <view>
          <view>
            <view class="table_padding_top">
              <navigator class="nav_left" url="/pages/food_recommendation/view?" v-show="user_group == '管理员' || $check_action('/food_recommendation/table','add') || $check_action('/food_recommendation/view','add')">添加</navigator>
						...
						<view class="view">
							<view class="diy_title" v-if=" false">
								<span>图片</span>
									...
									<view class="col" v-if="1 && $check_field('get','type')">
						<view class="view">
							<view class="diy_title" v-if="true">
								<span>类型</span>
							</view>
						...
						<view class="view">
							<view class="diy_title" v-if="true">
								...
								<span>
									...
									<view class="col" v-if="0 && $check_field('get','store_name')">
						<view class="view">
							<view class="diy_title" v-if="true">
								<span>店铺名称</span>
							</view>
				...
				<view class="col">
					<view class="view">
						<view class="create_time_block diy_filed diy_time">
                          ...
                          <button class="delete_a_btn" @click="delInfo(i)" v-show="user_group == '管理员' || $check_action('/food_recommendation/table','del') || $check_action('/food_recommendation/view','del')">删除</button>
                        </view>
					</view>
				</view>
				<view class="uni-padding-wrap uni-common-mt">
					<navigator  :url="'/pages/food_recommendation/view?' + field + '=' + o[field]"
						v-show="user_group == '管理员' || $check_action('/food_recommendation/table','set') || $check_action('/food_recommendation/view','set') || $check_action('/food_recommendation/view','get')" class="btn btn-primary">详情</navigator>
					                    									</view>
			</view>
		</view>
	</view>
