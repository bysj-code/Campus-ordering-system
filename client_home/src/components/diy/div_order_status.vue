	...
	<view class="diy_details diy_div_order_status">
		<view v-if="Object.keys(obj).length!==0" class="warp">
			...
			<view class="container">
				<view class="row">
					<view class="col">
						<button type="button" class="diy_btn" @click="to_form('/pages/comment_information/edit')" v-if="$check_action('/comment_information/edit','add') || $check_action('/comment_information/edit','set')" >评论</button>
					</view>
				</view>
			</view>
		</view>
